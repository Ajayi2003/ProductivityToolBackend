...
const readTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const task = yield DoneModel_1.default.find();
...
const readOneTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const task = yield DoneModel_1.default.findById(id);
        return res.status(200).json({
            message: "Task gotten",
            data: task
        });
...
const CreateTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const create = yield DoneModel_1.default.create({
            task,
            priority,
            isCompleted: false,
            image
...
const DeleteTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const remove = yield DoneModel_1.default.findByIdAndDelete(id);
        return res.status(200).json({
...
const UpdateTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const update = yield DoneModel_1.default.findByIdAndUpdate(req.params.id, { isCompleted: true }, { new: true });
        return res.status(201).json({
